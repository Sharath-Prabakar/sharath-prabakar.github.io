        ...
        <div className="admin-container">
            ...
            <div className={!hasAdminAccess ? "admin-content-restricted" : ""}>
                ...
                <div className="admin-actions">
                    ...
                    <button className="create-task-btn" onClick={openPriorityPopup} style={{ borderColor: '#e84393', color: '#fd79a8' }}>
                ...
                {isPriorityPopupOpen && (
                    <div className="popup-overlay">
                        <div className="popup-content priority-popup-content" onClick={(e) => e.stopPropagation()}>
                            <button className="close-btn" onClick={() => setIsPriorityPopupOpen(false)}>×</button>
